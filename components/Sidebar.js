import { HomeIcon, LibraryIcon, SearchIcon, RssIcon, HeartIcon, PlusCircleIcon } from '@heroicons/react/solid'
        ...
        <div className="text-gray-500 p-5 text-xs lg:text-sm border-r border-gray-900 overflow-y-scroll scrollbar-hide h-screen sm:max-w-[12rem] lg:max-w-[15rem] hidden md:inline-flex">
            <div className='space-y-4'>
                <div className=" text-center mx-4 my-0">
                    <img src="/SpotifyWhite.png" alt="Spotify" style={{ maxInlineSize: '80%', blockSize: 'auto' }} />
                </div>
